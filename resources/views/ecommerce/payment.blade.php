...
<body>
    ...
    <div class="main-content">
        ...
        <div class="payment-tab">
            <label>ช่องทางธนาคาร</label>
        </div>
        <div class="bank-payment">
            <div class="bank-list">
                <div class="bank-img">
                    <img src="/temp-ecommerce/payment-v2/resources/img/Kbank.png" alt="">
                </div>
                <div class="bank-detail">
                    <a href="/ecommerce-customer-confirm-payment/{{ $order->id }}" class="bank-name">บมจ.ธนาคารกสิกรไทย</a>
                    <p>ชื่อบัญชี: บริษัท เค.โฟร์. เทรดดิ้ง จำกัด</p>
                    <p>เลขที่บัญชี: 036-1-61765-7</p>
                </div>
            </div>
            <div class="bank-list">
                <div class="bank-img">
                    <img src="/temp-ecommerce/payment-v2/resources/img/TMB.jpg" alt="">
                </div>
                <div class="bank-detail">
                    <a href="/ecommerce-customer-confirm-payment/{{ $order->id }}" class="bank-name">บมจ.ธนาคารทหารไทย</a>
                    <p>ชื่อบัญชี: บริษัท เค.โฟร์. เทรดดิ้ง จำกัด</p>
                    <p>เลขที่บัญชี: 492-1-06205-7</p>
                </div>
            </div>
            <!-- <div class="bank-list">
                <div class="bank-img">
                    <img src="/temp-ecommerce/payment-v2/resources/img/SCB.png" alt="">
                </div>
                <div class="bank-detail">
                    <a href="#" class="bank-name">ธนาคารไทยพาณิชย์</a>
                    <p>ชื่อบัญชี: บริษัท เค.โฟร์. เทรดดิ้ง จำกัด</p>
                    <p>เลขที่บัญชี: 0-000-0-000</p>
                </div>
            </div> -->
        </div>
    </div>
