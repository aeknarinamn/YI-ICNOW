            ...
            <section class="product-detail-wrap">
                ...
                <div class="product-detail">
                    ...
                    <div class="is-half">
                        ...
                        <div class="product-number">
                            <div class="product-number-label">จำนวนคนในปาร์ตี้ :</div>
                ...
                <div class="product-order-description">
                    <div class="product-selec-detail">
                        <div class="product-selec-detail-row">
                            <div class="product-selec-detail-column is-60">
                                <div class="select-option">
                        ...
                        <div class="product-selec-detail-row">
                            <div class="control textarea-wrap">
                                ...
                                <textarea class="textarea" type="text" name="comment" id="description" maxlength="100"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
