...
<body>
    <div class="container">
        ...
        <form id="form-submit" action="{{ action('ICNOW\View\AddressController@addressDataStore') }}" method="post">
            {!! csrf_field() !!}
            <input type="hidden" name="lattitude" value="{{$mainDatas['lattitude']}}">
            <input type="hidden" name="longtitude" value="{{$mainDatas['longtitude']}}">
            <input type="hidden" name="line_user_id" value="{{$lineUserProfile->id}}">>
            <section style="margin-bottom: 30px">
                <div class="section-title address">โปรดระบุชื่อและที่อยู่ เป็นภาษาไทย</div>
                <div class="input-wrap">
                    *ชื่อ : <input type="text" name="first_name" id="first_name" class="input">
                </div>
                <div class="input-wrap" style="margin-top: 60px">
                    *นามสกุล : <input type="text" name="last_name" id="last_name" class="input">
                </div>
                <div class="input-wrap" style="margin-top: 60px">
                    *ที่อยู่ : <input type="text" name="address" id="address" class="input" value="{{$mainDatas['street_number']}} {{$mainDatas['route']}}">
                </div>
                <div class="input-wrap" style="margin-top: 60px">
                    *ตำบล : <input type="text" name="sub_district" id="sub_district" class="input" value="{{$mainDatas['sub_district']}}">
                </div>
                <div class="input-wrap" style="margin-top: 60px">
                    *อำเภอ : <input type="text" name="district" id="district" class="input" value="{{$mainDatas['district']}}">
                </div>
                <div class="input-wrap" style="margin-top: 60px">
                    *จังหวัด : <input type="text" name="province" id="province" class="input" value="{{$mainDatas['province']}}">
                </div>
                <div class="input-wrap" style="margin-top: 60px">
                    *รหัสไปรษณีย์ : <input type="text" name="post_code" id="post_code" class="input" value="{{$mainDatas['post_code']}}">
                </div>
                <div class="input-wrap" style="margin-top: 60px; margin-bottom: 30px">
                    *เบอร์ติดต่อ : <input type="text" name="phone_number" id="phone_number" class="input" value="{{$mainDatas['phone_number']}}">
                </div>
        ...
        <footer>
            <div class="footer-btn">
                ...
                <div class="footer-btn-column is-68 is-lg-80 text-right" style="padding-right: 40px">
                    <a href="#" onclick="submitForm()" class="link-to" id="btnSubmitForm">บันทึกที่อยู่ใหม่</a>
                </div>
                <!-- <div class="footer-btn-column is-68 is-lg-80 text-right" style="padding-right: 40px">
    ...
    <script>
        ...
        function submitForm(){
            ...
            var msgError = "";
            $isCheck = 1;
            // if(firstName == "" || lastName == "" || address == "" || subDistrict == "" || district == "" || province == "" || postCode == "" || phoneNumber == ""){
            //     $isCheck = 0;
            // }
            if(firstName == ""){
