...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="/icnow/resources/css/page/thank.css">
</head>
...
<body>
    <div class="container">
        ...
        <section>
            <div class="thank-banner-wrap text-center">
                <img src="/icnow/resources/images/out-service.png" alt="Button">
            </div>
            <div class="thank-button">
                <a href="/home-page" class="image-btn">
                    <img src="/icnow/resources/images/btn-back-to-home-page.png" alt="Button">
                </a>
                <a href="#" class="image-btn">
                    <img src="/icnow/resources/images/btn-back-to-line-chat.png" alt="Button">
                </a>
            </div>
        </section>
    </div>
