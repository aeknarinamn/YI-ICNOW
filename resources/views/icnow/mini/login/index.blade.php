...
<head>
    <title>Welcome to Yellow Cloud Platform</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <!-- global level css -->
    <link href="/admin/css/bootstrap.min.css" rel="stylesheet" />
    <!-- end of global level css -->
    <link href="/admin/vendors/iCheck/css/square/blue.css" rel="stylesheet" type="text/css" />
    <link href="/admin/vendors/bootstrapvalidator/css/bootstrapValidator.min.css" rel="stylesheet" />
    <!-- page level css -->
    <link rel="stylesheet" type="text/css" href="/admin/css/pages/login.css" />
...
<body>
                ...
                <div id="container_demo">
                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                            <form action="{{ action('ICNOW\Mini\MiniController@checkLogin') }}" id="authentication" autocomplete="on" method="post">
                                {!! csrf_field() !!}
                                <h3 class="black_bg">
                                    <img width="150px" height="40px" src="/img/yellow_logo.png" alt="Yellowidea">
                                </h3>
                                <div class="form-group ">
                                    <label style="margin-bottom:0;" for="email1" class="uname control-label"> <i class="livicon" data-name="mail" data-size="16" data-loop="true" data-c="#3c8dbc" data-hc="#3c8dbc"></i> Username
                                    </label>
                        ...
                        <!-- <div id="register" class="animate form">
                            <form action="index.html" id="register_here" autocomplete="on" method="post">
                                <h3 class="black_bg">
                                    <img src="/admin/img/logo.png" alt="josh logo">
                                    <br>Sign Up</h3>
                                <div class="form-group">
    ...
    <!-- end of global js -->
    <script src="/admin/vendors/bootstrapvalidator/js/bootstrapValidator.min.js" type="text/javascript"></script>
    <script src="/admin/vendors/iCheck/js/icheck.js" type="text/javascript"></script>
    <script src="/admin/js/pages/login.js" type="text/javascript"></script>
</body>
