...
<body>
	<div class="container">
		<form id="action-form" action="{{ action('Eplus\Customer\CustomerController@storeDataRegister') }}" method="post">
			{!! csrf_field() !!}
			...
			<div class="store-id">
				<div class="title font-medium">*รหัสลูกค้า (Banner)</div>

				<input id="banner_code" name="banner_code" class="sinput font-text" placeholder="กรุณาระบุ ">
			</div>
...
<script type='text/javascript'>
    function validate() {
        var validBannerCode = $('#banner_code').val();

        var isSubmit = 1;
        var msgError = ""; 
        if(validBannerCode == ""){
            isSubmit = 0;
            msgError += "กรุณากรอก รหัสลูกค้า (Banner)\n";
        }
