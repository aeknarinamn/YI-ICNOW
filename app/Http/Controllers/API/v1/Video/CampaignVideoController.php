...
namespace YellowProject\Http\Controllers\API\v1\Video;
...
class CampaignVideoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        CampaignVideo::checkFolderDefaultPath();
        $destinationPath = 'campaign_file/video';
        ...
        CampaignVideo::create([
            'video_url' => URL::to('/')."/".$destinationPath."/".$fileName,
        ]);
