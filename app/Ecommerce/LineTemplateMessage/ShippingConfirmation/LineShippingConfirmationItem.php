...
use YellowProject\Ecommerce\LineTemplateMessage\ShippingConfirmation\LineShippingConfirmation as Line;
use YellowProject\Ecommerce\LineTemplateMessage\ShippingConfirmation\LineShippingConfirmationMessage as LineMessage;
use YellowProject\Ecommerce\LineTemplateMessage\ShippingConfirmation\LineShippingConfirmationSticker as LineSticker;
use YellowProject\LineMessageType;

class LineShippingConfirmationItem extends Model
{
     ...
     * @var string
     */
    protected $table = 'fact_ecommerce_line_temp_shipping_confirmation';
     ...
     */
    protected $fillable = [
        'ecommerce_line_temp_shipping_confirmation_id',
		'message_type_id',
		'seq_no',
		'message_id',
        'sticker_id',
    ...
    protected static function boot() 
    {
       ...
       static::deleting(function($lineShippingConfirmationItem) {
            $lineShippingConfirmationItem->message()->delete();
            $lineShippingConfirmationItem->message()->sticker();
        });
    }
    ...
    {
        return $this->belongsTo(Line::class, 'ecommerce_line_temp_shipping_confirmation_id', 'id');
    }
