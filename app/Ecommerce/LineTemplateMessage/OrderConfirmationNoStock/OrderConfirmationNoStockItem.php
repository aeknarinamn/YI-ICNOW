...
use YellowProject\Ecommerce\LineTemplateMessage\OrderConfirmationNoStock\OrderConfirmationNoStock as Line;
use YellowProject\Ecommerce\LineTemplateMessage\OrderConfirmationNoStock\OrderConfirmationNoStockMessage as LineMessage;
use YellowProject\Ecommerce\LineTemplateMessage\OrderConfirmationNoStock\OrderConfirmationNoStockSticker as LineSticker;
use YellowProject\LineMessageType;

class OrderConfirmationNoStockItem extends Model
{
     ...
     * @var string
     */
    protected $table = 'fact_ecommerce_line_temp_order_confirmation_no_stock';
     ...
     */
    protected $fillable = [
        'ecommerce_line_temp_order_confirmation_no_stock_id',
		'message_type_id',
		'seq_no',
		'message_id',
        'sticker_id',
    ...
    protected static function boot() 
    {
       ...
       static::deleting(function($orderConfirmationNoStockItem) {
            $orderConfirmationNoStockItem->message()->delete();
            $orderConfirmationNoStockItem->message()->sticker();
        });
    }
    ...
    {
        return $this->belongsTo(Line::class, 'ecommerce_line_temp_order_confirmation_no_stock_id', 'id');
    }
