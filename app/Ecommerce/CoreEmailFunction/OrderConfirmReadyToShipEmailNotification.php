...
class OrderConfirmReadyToShipEmailNotification extends Model
{
    public static function emailToCustomer($customer,$order)
    {
    	$text = "Order Confirmation Payment Ready To Ship To Customer";
    ...
    {
    	$text = "Order Confirmation Payment Ready To Ship To DT";
    ...
    {
    	$text = "Order Confirmation Payment Ready To Ship To Admin";
