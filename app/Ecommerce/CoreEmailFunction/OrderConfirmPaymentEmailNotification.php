...
class OrderConfirmPaymentEmailNotification extends Model
{
    public static function emailToCustomer($customer,$order)
    {
    	$text = "Order Confirmation Payment To Customer";
    ...
    {
    	$text = "Order Confirmation Payment To DT";
    ...
    {
    	$text = "Order Confirmation Payment To Admin";
