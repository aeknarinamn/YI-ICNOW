...
class OrderConfirmShippingEmailNotification extends Model
{
    public static function emailToCustomer($customer,$order)
    {
    	$text = "Order Confirmation Shipping To Customer";
    ...
    {
    	$text = "Order Confirmation Shipping To DT";
    ...
    {
    	$text = "Order Confirmation Shipping To Admin";
