...
use YellowProject\Ecommerce\LineTemplateMessage\CustomerPaymentOverdue48\CustomerPaymentOverdue48;
use YellowProject\Ecommerce\LineTemplateMessage\LineTemplateMessageAuto\CustomerPaymentOverdue48 as LineCustomerPaymentOverdue48;
...
class OrderOverDuePayment48 extends Model
{
    public static function sentMessageCustomerPaymentOverdue48($customer,$order)
    {
    ...
    public static function setSendMessageToAdmin($customer,$order,$lineUserProfile)
    {
        $dtID = $customer->dt_id;
        $DTManagement = DTManagement::find($dtID);
        $orderConfirmation = LineCustomerPaymentOverdue48::first();
        $lineOrderConfirmation = CustomerPaymentOverdue48::where('id',$orderConfirmation->line_to_admin_template_id)->first();
    ...
    public static function setSendMessageToDT($customer,$order,$lineUserProfile)
    {
        ...
        $DTManagement = DTManagement::find($dtID);
        $orderConfirmation = LineCustomerPaymentOverdue48::first();
        $lineOrderConfirmation = CustomerPaymentOverdue48::where('id',$orderConfirmation->line_to_dt_template_id)->first();
        $setData = self::setDataConfirmation($customer,$order,$lineOrderConfirmation,$DTManagement);
    ...
    public static function setSendMessageToCustomer($customer,$order)
    {
        ...
        $DTManagement = DTManagement::find($dtID);
        $orderConfirmation = LineCustomerPaymentOverdue48::first();
        $lineOrderConfirmation = CustomerPaymentOverdue48::where('id',$orderConfirmation->line_to_customer_template_id)->first();
        $setData = self::setDataConfirmation($customer,$order,$lineOrderConfirmation,$DTManagement);
